...
=pod
 ...
 DTA::TokWrap->logInit();       ##-- initialize logging facility
 my $tw = DTA::TokWrap->new();  ##-- create a new tokenizer wrapper
 
 my $doc = $tw->open($xmlfile); ##-- "open" an XML source document
 $doc->makeKey('all');          ##-- create stand-off files
 $doc->close();                 ##-- ... and clean up temporary files
